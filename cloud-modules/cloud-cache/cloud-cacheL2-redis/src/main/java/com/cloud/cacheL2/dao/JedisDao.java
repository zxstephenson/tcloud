 ...
 * @since     3.1.0 
 */
public class JedisDao implements JedisCommands
{
    private static final Logger log = LoggerFactory.getLogger(JedisDao.class);
    ...
    public String get(String key) throws RedisDBException {
        String result = null;
        Jedis jedis = this.getShardedJedis();
        if (jedis == null) {
    ...
    public boolean setNX(String key, String value) throws RedisDBException
    {
        ...
        } catch (Exception e)
        {
            ...
            throw new RedisDBException(Constants.REDIS_EXCUTE_ERROR_CODE,
                    Constants.REDIS_EXCUTE_ERROR_MSG + ": "
                            + e.getMessage());
        } finally
        {
            jedis.close();
    ...
    public String getSet(String key, String value) throws RedisDBException
    {
        ...
        try
        {
            String obj = jedis.getSet(key, value);
            return obj;
        } catch (Exception e)
        {
            ...
            long time) throws RedisDBException
    {
        ...
        try
        {
            String obj = jedis.set(key, value, nxxx, expx, time);
            return obj;
        } catch (Exception e)
        {
            log.error("set redis error, key : {}", key, e);
            throw new RedisDBException(Constants.REDIS_EXCUTE_ERROR_CODE,
                    Constants.REDIS_EXCUTE_ERROR_MSG + ":" + e.getMessage());
        } finally
        {
            jedis.close();
        }
