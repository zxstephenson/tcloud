/**
 * <p>文件名称: ApiTxManagerService.java</p>
...
public interface ApiTxManagerService
{
     ...
     * @return 是否保存成功
     */
    boolean sendCompensateMsg(long currentTime, String groupId, String model,
            String address, String uniqueKey, String className,
