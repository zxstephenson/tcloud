package com.cloud.tx.springcloud.interceptor;
...
public class TransactionAspect implements Ordered {
    ...
    @Around("@annotation(com.cloud.tx.annotation.TxTransaction)")
    ...
    @Around("this(com.cloud.tx.annotation.ITxTransaction) && execution( * *(..))")
