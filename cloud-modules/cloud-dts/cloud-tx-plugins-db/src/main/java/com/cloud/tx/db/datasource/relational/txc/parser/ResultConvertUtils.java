/**
 * <p>文件名称: ResultConvertUtils.java</p>
...
public class ResultConvertUtils
{
    ...
    public static List<TxcLine> convertWithPrimary(ResultSet resultSet,
            String primaryKeyName, SQLType sqlType) throws SQLException
    {
            ...
            for (int i = 1; i <= metaData.getColumnCount(); i++)
            {
                ...
                if (i == metaData.getColumnCount()
                        && StringUtils.equalsIgnoreCase(
                                metaData.getColumnName(i), primaryKeyName)
                        && sqlType == SQLType.UPDATE)
                {

                    txcLine.setPrimaryKey(metaData.getColumnName(i));
                    txcLine.setPrimaryValue(getDataByType(i,
                ...
                } else
                {
                    ...
                    txcField.setValue(getDataByType(i,
                            metaData.getColumnType(i), resultSet));
    ...
    private static Object getDataByType(int index, int columnType,
