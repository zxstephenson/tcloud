/**
 * <p>文件名称: AbstractTxcConnection.java</p>
...
import com.cloud.tx.db.datasource.relational.AbstractTransactionThread;
import com.cloud.tx.db.datasource.relational.LCNConnection;
import com.cloud.tx.db.datasource.relational.txc.parser.TxcRuntimeContext;
        ...
        implements LCNConnection, TxcRuntimeContextService
{
    ...
    private static final Logger log = LoggerFactory.getLogger(AbstractTxcConnection.class);
    ...
    public AbstractTxcConnection(Connection connection,
            TxTransactionLocal transactionLocal,
            DataSourceService dataSourceService,
            TxcRollbackService txcRollbackService)
    {
        ...
        {
            log.info("this is txc start-connection");
            taskGroup = TaskGroupManager.getInstance().createTask(groupId,
                    transactionLocal.getType());
        } else
        {
            taskGroup = TaskGroupManager.getInstance().createTask(
    ...
    public Statement createStatement(int resultSetType,
            ...
            throws SQLException
    {
        Statement statement = connection.createStatement(resultSetType,
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException
    {
        ...
        PreparedStatement localPreparedStatement = connection
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType,
            ...
            throws SQLException
    {
        PreparedStatement localPreparedStatement = connection.prepareStatement(
