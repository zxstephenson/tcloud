/**
 * <p>文件名称: TxcPreparedStatement.java</p>
...
import com.cloud.tx.db.datasource.relational.txc.parser.ExecutePaser;
 ...
 */
public class TxcPreparedStatement extends TxcStatement
        implements PreparedStatement
{

    private static final Logger log = LoggerFactory.getLogger(TxcPreparedStatement.class);

    public TxcPreparedStatement(PreparedStatement localPreparedStatement,
            AbstractTxcConnection abstractTxcConnection, String sql)
    {
    ...
    private void addParam(int paramInt, Object paramObject1,
            Object paramObject2, Object paramObject3) throws SQLException
    {
    ...
    private void addParam(int paramInt, Object paramObject1,
            Object paramObject2) throws SQLException
    {
        List<Object> paramsList = getParamsList();
        paramsList.add(paramObject1);
    }
            ...
            throws SQLException
    {
        ...
        ((PreparedStatement) this.statement).setAsciiStream(paramInt,
                paramInputStream);
    }
            ...
            int paramInt2) throws SQLException
    {
        ...
        ((PreparedStatement) this.statement).setAsciiStream(paramInt1,
                paramInputStream, paramInt2);
    }
            ...
            throws SQLException
    {
        ...
        ((PreparedStatement) this.statement).setBigDecimal(paramInt,
                paramBigDecimal);
    }
    ...
    {
        addParam(paramInt, paramInputStream);
        ((PreparedStatement) this.statement).setBinaryStream(paramInt,
                paramInputStream);
    }
    ...
    {
        addParam(paramInt1, paramInputStream, paramInt2);
        ((PreparedStatement) this.statement).setBinaryStream(paramInt1,
                paramInputStream, paramInt2);
    }
    ...
    {
        addParam(paramInt, paramInputStream);
        ((PreparedStatement) this.statement).setBlob(paramInt,
                paramInputStream);
    }
            ...
            throws SQLException
    {
        ...
        ((PreparedStatement) this.statement).setBytes(paramInt,
                paramArrayOfByte);
    }
            ...
            throws SQLException
    {
        ...
        ((PreparedStatement) this.statement).setCharacterStream(paramInt,
                paramReader);
    }
            ...
            int paramInt2) throws SQLException
    {
        ...
        ((PreparedStatement) this.statement).setCharacterStream(paramInt1,
                paramReader, paramInt2);
    }
    ...
    {
        addParam(paramInt, paramReader);
        ((PreparedStatement) this.statement).setNCharacterStream(paramInt,
                paramReader);
    }
            ...
            throws SQLException
    {
        ...
        ((PreparedStatement) this.statement).setObject(paramInt1, paramObject,
                paramInt2);
    }
    ...
    public void setTimestamp(int paramInt, Timestamp paramTimestamp)
            throws SQLException
    {
        // addParam(paramInt, new Timestamp(paramTimestamp.getTime() -
        // paramTimestamp.getTime() % 1000));
        paramTimestamp.setNanos(0);
        addParam(paramInt, paramTimestamp);

        ((PreparedStatement) this.statement).setTimestamp(paramInt,
                paramTimestamp);
    }
    ...
    {
        addParam(paramInt1, paramInputStream, paramInt2);
        ((PreparedStatement) this.statement).setUnicodeStream(paramInt1,
                paramInputStream, paramInt2);
    }
